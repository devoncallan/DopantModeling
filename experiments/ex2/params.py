...
def configure_dopant_parameters(p, crystalline_mol_frac):
    if p.dopant == 'F4TCNQ':
        ...
        if p.DopantOrientation == DopantOrientation.ISOTROPIC:
            if p.edge_to_find == 'C 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_C_Kedge_isotropic.txt'
            elif p.edge_to_find == 'N 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_N_Kedge_isotropic.txt'
            elif p.edge_to_find == 'F 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_F_Kedge_isotropic.txt'
        else:
            if p.edge_to_find == 'C 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_C_Kedge.txt'
            elif p.edge_to_find == 'N 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_N_Kedge.txt'
            elif p.edge_to_find == 'F 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/Reduced_F4TCNQ_F_Kedge.txt'
    elif p.dopant == 'TFSI':
        p.mw[Materials.DOPANT_ID] = 280.14
        p.dopant_vol_frac = interpolate_dopant_vol_frac_TFSI(crystalline_mol_frac)
        if p.DopantOrientation == DopantOrientation.ISOTROPIC:
            if p.edge_to_find == 'C 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_C_Kedge_isotropic.txt'
            elif p.edge_to_find == 'N 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_N_Kedge_isotropic.txt'
            elif p.edge_to_find == 'F 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_F_Kedge_isotropic.txt'
        else:
            if p.edge_to_find == 'C 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_C_Kedge.txt'
            elif p.edge_to_find == 'N 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_N_Kedge.txt'
            elif p.edge_to_find == 'F 1s':
                p.material_dict['Material4'] = '/home/php/DopantModeling-dev/data/xspectra_refractive_indices/TFSI_2_F_Kedge.txt'
