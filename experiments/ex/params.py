...
from src.Morphology.Fibril.FibrilPostProcessor import DopantOrientation
...
from src.Morphology.Fibril.FibrilGenerator import FibrilOrientation, FibrilDistribution
